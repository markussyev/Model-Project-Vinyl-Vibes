...
const ArtistCard = ({ imgUrl, artistTitle, liked, handleSetLiked }) => {
  ...
  return (
    <div className="static artist-card w-60 h-82 p-5 flex flex-col content-between items-center space-y-6 rounded-xl bg-white drop-shadow-lg dark:bg-darkgray-light text-lightgray-default">
